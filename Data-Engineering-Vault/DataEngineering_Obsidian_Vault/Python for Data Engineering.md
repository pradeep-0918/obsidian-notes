...
| `pyspark` | Big data processing (see [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Apache Spark]]) |
...
- [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Apache Spark]] — PySpark is Python's interface to Spark
- [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Airflow]] — DAGs (pipeline workflows) are written in Python
