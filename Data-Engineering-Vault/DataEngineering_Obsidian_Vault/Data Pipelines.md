...
| Category | Tools |
|----------|-------|
| Orchestration | [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Airflow]], Prefect, Dagster |
| Batch processing | [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Apache Spark]], dbt, Pandas |
...
- [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Airflow]] — The most popular tool to orchestrate and schedule pipelines
- [[Apache Kafka]] — For streaming (real-time) pipelines
- [[Data-Engineering-Vault/DataEngineering_Obsidian_Vault/Apache Spark]] — For large-scale batch processing inside pipelines
